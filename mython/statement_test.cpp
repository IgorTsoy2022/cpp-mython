...
namespace ast {
    ...
    namespace {
        ...
        template <typename T>
        void AssertObjectValueEqual(const ObjectHolder& obj,
                                    const T& expected,
...
#define ASSERT_OBJECT_VALUE_EQUAL(obj, expected)                     \
    {                                                                \
        ...
        __assert_equal_private_os << #obj << "'s value_ != "sv       \
                                  << #expected << "s, "sv            \
                                  << FILE_NAME << ':' << __LINE__;   \
        AssertObjectValueEqual(obj, expected,                        \
        ...
        void TestVariable() {
            ...
            ASSERT(VariableValue("x"s).Execute(closure, context)
                                      .Get() == &num);
            ASSERT(VariableValue("w"s).Execute(closure, context)
                                      .Get() == &word);
            ASSERT_THROWS(VariableValue("unknown"s)
        ...
        void TestAssignment() {
            ...
            Assignment assign_x("x"s,
                std::make_unique<NumericConst>(
                    runtime::Number(57)));
            Assignment assign_y("y"s,
                std::make_unique<StringConst>(
                    runtime::String("Hello"s)));

            Closure closure = { 
                {"y"s, ObjectHolder::Own(runtime::Number(42))}
            };
        ...
        void TestFieldAssignment() {
            ...
            FieldAssignment assign_y(VariableValue{ "self"s }, "y"s,
            ...
            FieldAssignment assign_yz(
                VariableValue{ 
                    std::vector<std::string>{"self"s, "y"s}
                }, "z"s,
                std::make_unique<StringConst>(
                    runtime::String(
                        "Hello, world! Hooray! Yes-yes!!!"s)));
            {
                ObjectHolder o = assign_yz.Execute(closure, context);
                ASSERT(o);
                ASSERT_OBJECT_VALUE_EQUAL(o,
                    "Hello, world! Hooray! Yes-yes!!!"s);
            }

            ASSERT(object.Fields().find("y"s) != 
                object.Fields().end());
            const auto* subobject = 
                object.Fields().at("y"s)
                               .TryAs<runtime::ClassInstance>();
            ASSERT(subobject != nullptr && 
                   subobject->Fields().find("z"s) !=
                   subobject->Fields().end());
            ASSERT_OBJECT_VALUE_EQUAL(subobject->Fields().at("z"s),
                   "Hello, world! Hooray! Yes-yes!!!"s);
        ...
        void TestStringify() {
            ...
            {
                auto result = 
                    Stringify(std::make_unique<NumericConst>(57))
            ...
            {
                auto result = 
                    Stringify(std::make_unique<StringConst>("Wazzup!"s))
                    .Execute(empty, context);
            ...
            }
            {
                ...
                methods.push_back({ "__str__"s, {},
                    std::make_unique<NumericConst>(842) });

                runtime::Class cls("BoxedValue"s, std::move(methods),
                                   nullptr);

                auto result = 
                    Stringify(std::make_unique<NewInstance>(cls))
                    .Execute(empty, context);
            ...
            }
            {
                ...
                runtime::Closure closure{ 
                    {"x"s, 
                     ObjectHolder::Own(runtime::ClassInstance{cls})}
                };

                std::ostringstream expected_output;
                expected_output << closure.at("x"s).Get();

                Stringify str(std::make_unique<VariableValue>("x"s));
                ASSERT_OBJECT_VALUE_EQUAL(
                    str.Execute(closure, context),
                    expected_output.str());
            }
            {
                Stringify str(std::make_unique<None>());
                ASSERT_OBJECT_VALUE_EQUAL(
                    str.Execute(empty, context), "None"s);
            }
        ...
        void TestNumbersAddition() {
            ...
            Add sum(std::make_unique<NumericConst>(23),
        ...
        void TestStringsAddition() {
            ...
            Add sum(std::make_unique<StringConst>("23"s),
                    std::make_unique<StringConst>("34"s));

            Closure empty;
            ASSERT_OBJECT_VALUE_EQUAL(sum.Execute(empty, context),
                                      "2334"s);
        ...
        void TestBadAddition() {
            ...
            ASSERT_THROWS(
                Add(std::make_unique<NumericConst>(42),
                    std::make_unique<StringConst>("4"s))
                    .Execute(empty, context),
                    std::runtime_error);
            ASSERT_THROWS(
                Add(std::make_unique<StringConst>("4"s),
                    std::make_unique<NumericConst>(42))
                    .Execute(empty, context),
                    std::runtime_error);
            ASSERT_THROWS(
                Add(std::make_unique<None>(),
                    std::make_unique<StringConst>("4"s))
                    .Execute(empty, context),
                    std::runtime_error);
            ASSERT_THROWS(
                Add(std::make_unique<None>(),
                    std::make_unique<None>())
                    .Execute(empty, context),
                    std::runtime_error);
        ...
        void TestSuccessfulClassInstanceAdd() {
            ...
            methods.push_back(
                { "__add__"s, {"value_"s},
                std::make_unique<Add>(
                    std::make_unique<StringConst>("hello, "s),
                    std::make_unique<VariableValue>("value_"s)) });

            runtime::Class cls("BoxedValue"s,
                               std::move(methods), nullptr);

            Closure empty;
            auto result = 
                Add(std::make_unique<NewInstance>(cls),
                    std::make_unique<StringConst>("world"s))
                    .Execute(empty, context);
        ...
        void TestClassInstanceAddWithoutMethod() {
            ...
            Closure empty;
            Add addition(std::make_unique<NewInstance>(cls),
                         std::make_unique<StringConst>("world"s));
            ASSERT_THROWS(addition.Execute(empty, context),
                          std::runtime_error);
        ...
        void TestCompound() {
            ...
            Compound cpd{
                std::make_unique<Assignment>("x"s,
                    std::make_unique<StringConst>("one"s)),
                std::make_unique<Assignment>("y"s,
                    std::make_unique<NumericConst>(2)),
                std::make_unique<Assignment>("z"s,
                    std::make_unique<VariableValue>("x"s)),
            };
        ...
        void TestFields() {
            ...
            methods.push_back(
                { "__init__"s, {},
                  {std::make_unique<FieldAssignment>(
                      VariableValue{"self"s}, "value"s,
                      std::make_unique<NumericConst>(0))} });
            methods.push_back(
                { "value"s, {},
                  {std::make_unique<VariableValue>(
                      std::vector<std::string>{"self"s, "value"s})} });
            methods.push_back(
                { "add"s, {"x"s},
                  {std::make_unique<FieldAssignment>(
                      VariableValue{"self"s}, "value"s,
            ...
            for (int i = 1, expected = 0; i < 10;
                ...
                inst.Call("add"s,
                    { ObjectHolder::Own(runtime::Number(i)) },
                    context);
            }
        ...
        void TestBaseClass() {
            ...
            methods.push_back(
                { "GetValue"s, {},
                  std::make_unique<VariableValue>(
                      std::vector{"self"s, "value"s}) });
            methods.push_back(
                { "SetValue"s, {"x"s},
                  std::make_unique<FieldAssignment>(
                      VariableValue{"self"s}, "value"s,
                      std::make_unique<ast::VariableValue>("x"s)) });
        ...
        void TestInheritance() {
            ...
            methods.push_back(
                { "GetValue"s, {"z"s},
                  std::make_unique<VariableValue>("z"s) });
            methods.push_back(
                { "AsString"s, {},
                  std::make_unique<StringConst>("value"s) });
            runtime::Class cls("StringableValue"s,
                               std::move(methods), &base);
        ...
        void TestOr() {
            auto test_or = [](bool lhs, bool rhs) {
                Or or_statement{ std::make_unique<BoolConst>(lhs),
                                 std::make_unique<BoolConst>(rhs) };
                Closure closure;
                runtime::DummyContext context;
                ASSERT_EQUAL(runtime::Equal(
                    or_statement.Execute(closure, context),
        ...
        void TestAnd() {
            auto test_and = [](bool lhs, bool rhs) {
                And and_statement{ std::make_unique<BoolConst>(lhs),
                                   std::make_unique<BoolConst>(rhs) };
                Closure closure;
                runtime::DummyContext context;
                ASSERT_EQUAL(runtime::Equal(
                    and_statement.Execute(closure, context),
                    ObjectHolder::Own(runtime::Bool(true)), context),
                    lhs && rhs);
            };
        ...
        void TestNot() {
            auto test_not = [](bool arg) {
                Not not_statement{ std::make_unique<BoolConst>(arg) };
                Closure closure;
                runtime::DummyContext context;
                ASSERT_EQUAL(runtime::Equal(
                    not_statement.Execute(closure, context),
                    ObjectHolder::Own(runtime::Bool(true)), context),
                    !arg);
            };
